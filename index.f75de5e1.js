...
appendRow.addEventListener("click", (e)=>{
    ...
    rowsCurrent++;
    if (rowsCurrent >= max) setButton(e.target, true);
    else setButton(removeRow, false);
});
removeRow.addEventListener("click", (e)=>{
    rowsCurrent--;
    if (rowsCurrent) tbody.removeChild(tbody.lastElementChild);
    if (rowsCurrent <= min) setButton(e.target, true);
...
appendColumn.addEventListener("click", (e)=>{
    ...
    if (columnsCurrent === max) setButton(e.target, true);
...
removeColumn.addEventListener("click", (e)=>{
    ...
    if (columnsCurrent <= min) setButton(e.target, true);
